...
public class Main {
    public static void main(String[] args) {
        ...
        DebitCard debitCard = new DebitCardBonus(5000.00, 100.00);
        ...
        creditCard.pay(5000.00);
        System.out.println(creditCard.getAvailableCapital());


        DebitCard debitCard2 = new DebitCardAccumulate(500.00);
        debitCard2.pay(500.00);
        debitCard2.topUp(1000.00);
        debitCard2.pay(500.00);
        System.out.println(debitCard2.getAvailableCapital());
